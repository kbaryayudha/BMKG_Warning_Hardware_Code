        ...
        if(currentMillis - previousMillis >= 1000) {
            ...
            if(i == false) {
                ...
                if(reset==true && test_value=="true" && real_value=="false") {
                    digitalWrite(inet,HIGH);
                    client.println("POST /api/v1/esp32/change-state?province=demonstration&site=mobile_demo&test=true&real=false HTTP/1.1");
                    client.println("Host: semarsiren.id");
                    client.println("Connection: close");
                    client.println();
                    reset = false;
                    ...
                    digitalWrite(inet,HIGH);
                    client.println("POST /api/v1/esp32/change-state?province=demonstration&site=mobile_demo&test=false&real=true HTTP/1.1");
                    client.println("Host: semarsiren.id");
                    client.println("Connection: close");
                    client.println();
                    reset = false;
                    ...
                    digitalWrite(inet,HIGH);
                    client.println("POST /api/v1/esp32/change-state?province=demonstration&site=mobile_demo&test=false&real=false HTTP/1.1");
                    client.println("Host: semarsiren.id");
                    client.println("Connection: close");
                    client.println();
                    reset = true;
